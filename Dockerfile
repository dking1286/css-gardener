...
RUN apk add --update --no-cache curl bash make
...
# Adapted from https://github.com/nodejs/docker-node/blob/3c10e908934690b6af4f8f83b7e5e1da49926b34/12/alpine3.9/Dockerfile 
